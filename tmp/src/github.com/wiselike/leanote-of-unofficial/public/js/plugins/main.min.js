...
define("history",[],function(){var t=['<div class="modal fade history-modal" tabindex="-1" role="dialog" aria-hidden="true">','<div class="modal-dialog modal-lg ">','<div class="modal-content">','<div class="modal-header">','<h4 class="modal-title" class="modalTitle">NaN',"</div>",'<div class="modal-body clearfix">','<div class="history-list-wrap pull-left">','<div class="history-list-header">'+getMsg("history")+' (<span class="history-num"></span>)</div>','<div class="history-list list-group"></div>',"</div>",'<div class="history-content-wrap pull-left">','<div class="history-content-header">','<a class="btn btn-primary back">'+getMsg("restoreFromThisVersion")+"</a>",'<a class="btn btn-primary delete">'+getMsg("deleteThisHistoryVersion")+"</a>",'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>',"</div>",'<div class="history-content"></div>',"</div>","</div>",'<div class="modal-footer hide">','<button type="button" class="btn btn-default" data-dismiss="modal">'+getMsg("close")+"</button>","</div>","</div>","</div>","</div>"].join(""),e=$(t),i=e.find(".history-content"),s=e.find(".history-list"),o=e.find(".history-num"),n={note:null,list:[],curIndex:0,renderContent:function(t){var e=this.list[t].Content;this.curIndex=t;var o="<div>",n="</div>";this.note.IsMarkdown&&(o="<pre>",n="</pre>",e=trimTitle(e)),i.html(o+e+n);var a=s.find("a");a.removeClass("active"),a.eq(t).addClass("active")},render:function(t){var i="";if(this.list=t,t)for(var n=0;n<t.length;++n){var a=t[n];i+='<a class="list-group-item" data-index="'+n+'"><span class="badge">#'+(t.length-n)+"</span>"+goNowToDatetime(a.UpdatedTime)+"</a>"}s.html(i),this.renderContent(0),o.html(t.length),e.modal({show:!0})},bind:function(){var t=this;$("#contentHistory").click(function(){t.getHistories()}),s.on("click","a",function(){var e=$(this).data("index");t.renderContent(e)}),e.find(".back").click(function(){confirm(getMsg("confirmBackup"))&&(Note.curChangedSaveIt(!0),note=Note.cache[Note.curNoteId],setEditorContent(t.list[t.curIndex].Content,note.IsMarkdown),e.modal("hide"),Note.curChangedSaveIt(!0))}),e.find(".delete").click(function(){confirm(getMsg("confirmHistoryDelete"))&&ajaxPost("/noteContentHistory/deleteHistory",{noteId:Note.curNoteId,userId:Note.cache[Note.curNoteId].UserId,timeToDel:t.list[t.curIndex].UpdatedTime},function(e){t.getHistories()})})},getHistories:function(){var t=this,i=Note.getCurNote();t.note=i,ajaxGet("/noteContentHistory/listHistories",{noteId:Note.curNoteId},function(i){return!isArray(i)||i.length<1?(alert(getMsg("noHistories")),void e.modal("hide")):void t.render(i)})},init:function(){this.bind()}};n.init()});
